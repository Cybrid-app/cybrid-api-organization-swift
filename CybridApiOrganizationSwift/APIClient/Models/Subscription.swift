...
@objc public class Subscription: NSObject, Codable, JSONEncodable {
    ...
    public init(guid: String, organizationGuid: String? = nil, name: String, type: ModelType, url: String, signingKey: String? = nil, deliveriesFailingSince: Date? = nil, environment: String, state: String, failureCode: String? = nil, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.guid = guid
