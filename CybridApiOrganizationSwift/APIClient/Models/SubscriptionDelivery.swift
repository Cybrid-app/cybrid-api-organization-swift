...
@objc public class SubscriptionDelivery: NSObject, Codable, JSONEncodable {
    ...
    public init(guid: String, response: String? = nil, subscriptionEventGuid: String, subscriptionGuid: String, state: State, nextAttemptAt: Date? = nil, attemptCount: Int, completedAt: Date? = nil, failedAt: Date? = nil, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.guid = guid
