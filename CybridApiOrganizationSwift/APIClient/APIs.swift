...
// We reverted the change of CybridApiOrganizationSwiftAPI to CybridApiOrganizationSwift introduced in https://github.com/OpenAPITools/openapi-generator/pull/9624
...
@available(*, deprecated, renamed: "CybridApiOrganizationSwiftAPI")
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:]) {
        ...
        addHeaders(CybridApiOrganizationSwiftAPI.customHeaders)
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = CybridApiOrganizationSwiftAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() -> Self {
        credential = CybridApiOrganizationSwiftAPI.credential
        return self
    }
}
