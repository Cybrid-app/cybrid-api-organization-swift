...
*SubscriptionsAPI* | [**updateSubscription**](docs/SubscriptionsAPI.md#updatesubscription) | **PATCH** /api/subscriptions/{subscription_guid} | Patch subscription


## Documentation For Models

 - [ErrorResponseOrganizationModel](docs/ErrorResponseOrganizationModel.md)
 - [OrganizationListOrganizationModel](docs/OrganizationListOrganizationModel.md)
 ...
 - [PatchSubscriptionOrganizationModel](docs/PatchSubscriptionOrganizationModel.md)
